...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/armor.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp0/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--percent', type=float, default=0.1, help='prune percentage')  # 一般写0.5就好，50%剪枝
